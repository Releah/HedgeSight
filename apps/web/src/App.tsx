...
type AlertRule={id:string;name:string;folderId:string|null;triggerKind:"check_down"|"check_degraded"|"check_recovered";severity:"info"|"warning"|"critical";messageTemplate:string;conditions:{deviceIds?:string[];checkKinds?:string[]};channelIds:string[];enabled:boolean;mutedUntil:string|null;cooldownSeconds:number;notifyRecovery:boolean;lastTriggeredAt:string|null};
